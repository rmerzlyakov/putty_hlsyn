                      ...
                      int protocol, int protcfginfo)
{
    ...
    /*
     * The Window/Colours/Colorization panel.
     */
    ctrl_settitle(b, "Window/Colours/Colorization",
                  "Colorization b/w output Cisco and Huawei routers");

    s = ctrl_getset(b, "Window/Colours/Colorization", "charclass",
                    "Behaviour");

    ctrl_checkbox(s, "Enable colorization", 'i',
                  HELPCTX(appearance_title),
                  conf_checkbox_handler,
                  I(CONF_colorize));
